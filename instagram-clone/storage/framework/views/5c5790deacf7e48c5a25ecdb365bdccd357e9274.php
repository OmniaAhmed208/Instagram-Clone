...
<?php $__env->startSection('title'); ?> Explore <?php $__env->stopSection(); ?>
<?php $__env->startSection('css'); ?> "<?php echo e(asset('/css/index.css')); ?>" <?php $__env->stopSection(); ?>



<?php $__env->startSection('oneExplore-album-Content'); ?>
...
<?php $__env->startSection('oneExplore-video-Content'); ?>
			...
			<div class="row row-cols-4 d-flex">
				<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col mx-lg-3 flex-fill">
						<a href="<?php echo e($post->path()); ?>" data-bs-toggle="modal" data-bs-target="#explorePostModal">
								...
								<?php $__currentLoopData = $post->media(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($media->content_type == 'video'): ?>
										<?php echo $__env->yieldContent('oneExplore-video-Content'); ?>
									<?php else: ?>
										<?php echo $__env->yieldContent('oneExplore-photo-Content'); ?>
									<?php endif; ?>
...
<input type="hidden" id="rowperpage" value="<?php echo e($rowperpage); ?>">
<input type="hidden" id="totalrecords" value="<?php echo e($totalrecords); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Instagram-Clone\instagram-clone\resources\views/posts/explore.blade.php ENDPATH**/ ?>